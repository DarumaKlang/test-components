...
const InputNumber = ({ id, label, value, setter }: InputNumberProps) => (
    <div className="text-center">
        ...
        <input
            ...
            className="w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 p-1 text-center font-bold text-gray-900"
        />
    </div>
);